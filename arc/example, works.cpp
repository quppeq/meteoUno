...
void httpPOST(String data, int timeout, boolean debug){
  ...
  String postRequest =  String("POST ") + String("/arduino/postData") + String(" HTTP/1.1\r\n") +
    ...
    String("Content-Length: 71\r\n\r\n") +
    String("{\"name\":\"quppeq\",\"data\":\"Seryoga, wrubi arduinoEEEEEEEEEEEEEEEEEEE\"} \r\n\r\n");
  String sendCmd = "AT+CIPSEND=";//determine the number of caracters to be sent/.

  String post1 = String("POST ") + String("/arduino/postData") + String(" HTTP/1.1\r\n");
  String post2 = String("Host: quppeq.pythonanywhere.com\r\n");
  String post3 = String("Content-Type: application/json\r\n");
  String post4 = String("Content-Length: 71\r\n\r\n");
  String post5 = String("{\"name\": \"quppeq\", \"data\": \"Seryoga, wrubi arduinoEEEEEEEEEEEEEEEEEEE\"}\r\n");
...
//    wifiSerial.write(post1.c_str());
//    delay(100);
//    wifiSerial.write(post2.c_str());
//    delay(100);
//    wifiSerial.write(post3.c_str());
//    delay(100);
//    wifiSerial.write(post4.c_str());
//    delay(100);
//    wifiSerial.write(post5.c_str());
//    wifiSerial.println();
    ...
    if( wifiSerial.find("SEND OK"))
    {
      ...
      while (wifiSerial.available())
      {
        String tmpRwifiSerial = wifiSerial.readString();
        Serial.println(tmpRwifiSerial);
      }
      delay(100);
      if(debug)
      {
      ...
      sendToWifi("AT+CIPCLOSE",1000,DEBUG);
    }
    sendToWifi("AT+CIPCLOSE",1000,DEBUG);
  }
}
